...
V1  EQU 0X2C	    ;4 BYTES	GET CYPHERTEXT HERE CAN BE USED FOR OTHER THINGS    (OVERWRITTEN AT CALL)
...
NONCELO EQU 0X48    ;4 BYTES   COUNTER FOR NONCE DO NOT TOUCH
NONCEHI EQU 0X4C    ;4 BYTES   COUNTER FOR NONCE DO NOT TOUCH
